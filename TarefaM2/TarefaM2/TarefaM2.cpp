...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola 3D -- Julian!", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model1 = glm::translate(model1, glm::vec3(0.5f));
		model1 = glm::scale(model1, glm::vec3(0.5f));

		glUniformMatrix4fv(modelLoc, 1, FALSE, glm::value_ptr(model1));
